	...
	<el-container>
		...
		<el-main class="nopadding">
			<scTable ref="table" :apiObj="apiObj" row-key="id" border stripe>
				...
				<el-table-column label="所属分类" prop="video_cate.name" width="120"></el-table-column>
...
export default {
	...
	data() {
		return {
			...
			apiObj: this.$API.website.video.list,
			selection: [],
			search: {},
			//所需数据选项
			options: [],
